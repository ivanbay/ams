        ...
        <div class="row">
            ...
            <div class="animated flipInY col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <div id="totalAssets_bar" style="width:100%; height:300px;"></div>
                    </div>
                </div>
            </div>
            <!-- /bar charts -->
            ...
            <div class="animated flipInY col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <div id="assetCategories_bar" style="width:100%; height:300px;"></div>
                    </div>
                </div>
            </div>
            <!-- /bar charts -->
        ...
        <div class="row">
            ...
            <div class="animated flipInY col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <div id="assetStatus_bar" style="width:100%; height:300px;"></div>
                    </div>
                </div>
            </div>
            <!-- /bar charts -->
            ...
            <div class="animated flipInY col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <div id="userRole_bar" style="width:100%; height:300px;"></div>
                    </div>
                </div>
            </div>
            <!-- /bar charts -->           
