        ...
        <div class="row">
            ...
            <div class="animated flipInY col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <div id="totalAssets_line" style="width:100%; height:300px;"></div>
                    </div>
                </div>
            </div>
            <!-- /bar charts -->
            ...
            <div class="animated flipInY col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <div id="assetCategories_line" style="width:100%; height:300px;"></div>
                    </div>
                </div>
            </div>
            <!-- /bar charts -->
        ...
        <div class="row">
            ...
            <div class="animated flipInY col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <div id="assetStatus_line" style="width:100%; height:300px;"></div>
                    </div>
                </div>
            </div>
            <!-- /bar charts -->
            ...
            <div class="animated flipInY col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <div id="userRole_line" style="width:100%; height:300px;"></div>
                    </div>
                </div>
            </div>
            <!-- /bar charts -->           
